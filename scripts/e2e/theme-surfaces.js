...
// Built-in sRGB paint. The settings rail and the composer plate carry their
// acrylic veil inside the token itself (`--ds-settings-rail-bg` 56% /
// `--ds-bg-composer` & `--ds-bg-elevated-primary` 80%), so their built-in
// samples are translucent; the paint still equals the token verbatim on both
// platforms (macOS restores the opaque `-plate` in tokens.css, so its samples
// stay opaque here too, since this probe never sets `data-platform`).
const DEFAULT_RGBA = {"light":{"rail":[243,243,243,143],"search":[255,255,255,255],"active":[224,224,225,255],"knob":[255,255,255,255],"composer":[255,255,255,204],"pluginSearch":[243,243,243,255],"capabilitySearch":[243,243,243,255],"pluginFocus":[255,255,255,255],"capabilityFocus":[255,255,255,255],"scrim":[25,29,32,71],"modalVeil":[25,28,31,82],"toolRow":[51,51,51,5],"toolRowPlain":[51,51,51,5],"toolRowError":[51,51,51,5],"codeHead":[28,28,28,9],"mermaidCanvas":[255,255,255,235],"thinkingCode":[255,255,255,235],"sendDisabled":[142,142,144,255],"kbd":[26,26,26,20]},"dark":{"rail":[0,0,0,143],"search":[33,33,33,255],"active":[255,255,255,26],"knob":[24,24,24,255],"composer":[32,32,32,204],"pluginSearch":[255,255,255,13],"capabilitySearch":[255,255,255,13],"pluginFocus":[255,255,255,18],"capabilityFocus":[255,255,255,18],"scrim":[0,0,0,115],"modalVeil":[24,24,24,199],"toolRow":[255,255,255,9],"toolRowPlain":[0,0,0,0],"toolRowError":[255,99,99,18],"codeHead":[255,255,255,10],"mermaidCanvas":[24,24,24,235],"thinkingCode":[24,24,24,235],"sendDisabled":[255,255,255,46],"kbd":[255,255,255,20]}};
...
Object.assign(DEFAULT_RGBA.light, {
  // The card consumes `--ds-bg-composer`, so it rides the light composer veil.
  asktoolCard: [255, 255, 255, 204],
