...
export const de = {
  "app": {
    ...
    "starting": "Pi-Desktop-Next wird gestartet…",
  ...
  "tray": {
    ...
    "open": "Öffnen Sie Pi-Desktop-Next",
    "quit": "Beenden Sie Pi-Desktop-Next",
    "askTitle": "Lassen Sie Pi-Desktop-Next im Hintergrund laufen?",
    "askBody": "Wenn Sie das Fenster schließen, kann Pi-Desktop-Next in der Taskleiste weiterlaufen, sodass nichts verloren geht. Sie können dies jederzeit in den Einstellungen ändern.",
    "closeToTray": "In der Taskleiste",
    "confirmQuitTitle": "Pi-Desktop-Next beenden?",
  ...
  "chat": {
    ...
    "placeholder": "Bitten Sie Pi-Desktop-Next um Hilfe bei allem",
...
sklm: {
    ...
    "pluginProviderKeyHint":
      "Wird in Pi-Desktop-Next gespeichert und von der Laufzeitumgebung verwendet. Das Plugin erhält ihn niemals.",
...
"importConfirm": "Importierte Erweiterungen laufen im Agentenprozess mit denselben Rechten wie die Tools des Agenten. Deklarierte Skills können dem Agenten Anweisungen hinzufügen, und deklarierte Abhängigkeiten werden mit npm installiert (Installationsskripte deaktiviert). Fortfahren?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Fügt die Anbieter, die dieses Plugin definiert, zur Anbieterliste in den Einstellungen hinzu. Das Plugin liefert den Endpunkt und die Modelle; Ihr API-Schlüssel bleibt in Pi-Desktop-Next.",
      "desktop.control": "Erlaubt den Aufruf des geprüften Pi-Desktop-Next-Katalogs; destruktive Vorgänge benötigen weiterhin confirm=true, und das MCP-Bearer-Token wird nicht offengelegt.",
      ...
      "keyboard.globalShortcut": "Registriert systemweite Tastaturkürzel, die die eigenen Befehle dieses Plugins auslösen, während Pi-Desktop-Next nicht fokussiert ist.",
  ...
  "status": {
    ...
    "dbSchemaTooNew":
      "Diese Pi-Desktop-Next-Version ist älter als Ihre lokalen Daten (Datenschema {{found}}, diese Version unterstützt {{supported}}). Installieren Sie die neuere Pi-Desktop-Next-Version, die diese Daten zuletzt geöffnet hat, oder eine spätere.",
    "archMismatch":
