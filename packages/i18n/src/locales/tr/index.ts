...
export const tr = {
  app: {
    ...
    starting: "Pi-Desktop-Next başlatılıyor…",
  ...
  tray: {
    ...
    open: "Pi-Desktop-Next’u aç",
    quit: "Pi-Desktop-Next’tan çık",
    askTitle: "Pi-Desktop-Next arka planda çalışmaya devam etsin mi?",
    askBody:
      "Pencereyi kapattığınızda Pi-Desktop-Next sistem tepsisinde çalışmaya devam edebilir; hiçbir şey kaybolmaz. Bunu Ayarlar’dan dilediğiniz zaman değiştirebilirsiniz.",
    closeToTray: "Tepsiye kapat",
    confirmQuitTitle: "Pi-Desktop-Next'tan çıkılsın mı?",
    confirmQuitBody:
  ...
  menu: {
    ...
    appHelp: "Pi-Desktop-Next yardımı",
  ...
  chat: {
    ...
    placeholder: "Pi-Desktop-Next’tan herhangi bir konuda yardım isteyin",
...
sklm: {
    ...
    pluginProviderKeyHint: "Pi-Desktop-Next’ta saklanır ve çalışma zamanı tarafından kullanılır. Eklenti bu anahtarı asla almaz.",
...
importConfirm: "İçe aktarılan uzantılar ajan sürecinde, ajanın kendi araçlarıyla aynı erişimle çalışır. Bildirilen beceriler ajana talimatlar ekleyebilir ve bildirilen bağımlılıklar npm ile yüklenir (yükleme betikleri devre dışı). Devam edilsin mi?",
    ...
    permissionHelp: {
      ...
      "provider.register":
        "Bu eklentinin tanımladığı servisleri Ayarlar’daki servis listesine ekler. Uç noktayı ve modelleri eklenti sağlar; API anahtarınız Pi-Desktop-Next’ta kalır.",
      "desktop.control":
        "Eklentinin incelenmiş Pi-Desktop-Next denetim kataloğunu çağırmasını sağlar. Yıkıcı işlemler yine confirm=true gerektirir; MCP bearer token eklentiye verilmez.",
      ...
      "keyboard.globalShortcut": "Pi-Desktop-Next odakta değilken bu eklentinin kendi komutlarını tetikleyen sistem geneli klavye kısayollarını kaydeder.",
  ...
  status: {
    ...
    dbSchemaTooNew:
      "Bu Pi-Desktop-Next sürümü yerel verilerinizden daha eski (veri şeması {{found}}, bu sürüm {{supported}} destekliyor). Bu verileri en son açan daha yeni Pi-Desktop-Next sürümünü veya sonrasını yükleyin.",
    archMismatch:
