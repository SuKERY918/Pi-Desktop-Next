...
export const es = {
  "app": {
    "shellName": "Pi-Desktop-Next",
    "tagline": "Socio de codificación de IA local",
    "starting": "Iniciando Pi-Desktop-Next…",
  ...
  "tray": {
    ...
    "pinned": "Fijadas",
    "viewMore": "Ver más…",
    "open": "Abrir Pi-Desktop-Next",
    "quit": "Salir de Pi-Desktop-Next",
    "askTitle": "¿Mantener Pi-Desktop-Next ejecutándose en segundo plano?",
    "askBody": "Cuando cierra la ventana, Pi-Desktop-Next puede seguir ejecutándose en la bandeja del sistema para que no se pierda nada. Puedes cambiar esto en cualquier momento en Configuración.",
    "closeToTray": "Cerca de la bandeja",
    "confirmQuitTitle": "¿Salir de Pi-Desktop-Next?",
  ...
  "menu": {
    ...
    "appHelp": "Ayuda de Pi-Desktop-Next",
  ...
  "chat": {
    ...
    "placeholder": "Pídale ayuda a Pi-Desktop-Next con cualquier cosa",
...
sklm: {
    ...
    "pluginProviderKeyHint":
      "Se guarda en Pi-Desktop-Next y lo usa el entorno de ejecución. El complemento nunca lo recibe.",
    ...
    "thinkingDisplayModeDesc": "Detallado muestra razonamiento, herramientas y texto intermedio en su sitio. Compacto agrupa ese trabajo en un proceso, muestra un indicador mientras se razona y oculta el razonamiento al terminar.",
...
"importConfirm": "Las extensiones importadas se ejecutan en el proceso del agente con el mismo acceso que sus propias herramientas. Las habilidades declaradas pueden añadir instrucciones al agente y las dependencias declaradas se instalan con npm (scripts de instalación desactivados). ¿Continuar?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Agregue los proveedores que define este complemento a la lista de proveedores de Configuración. El complemento aporta el punto final y los modelos; su clave API permanece en Pi-Desktop-Next.",
      "desktop.control": "Permite invocar el catálogo de control de Pi-Desktop-Next revisado; las operaciones destructivas siguen requiriendo confirm=true y el token bearer de MCP no se expone.",
      ...
      "keyboard.globalShortcut": "Registra atajos de teclado del sistema que activan los comandos propios de este complemento mientras Pi-Desktop-Next no tiene el foco.",
  ...
  "status": {
    ...
    "dbSchemaTooNew":
      "Esta versión de Pi-Desktop-Next es más antigua que tus datos locales (esquema de datos {{found}}, esta versión admite {{supported}}). Instala la versión más reciente de Pi-Desktop-Next que abrió estos datos por última vez, o una posterior.",
    "archMismatch":
