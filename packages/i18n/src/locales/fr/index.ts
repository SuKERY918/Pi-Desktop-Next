...
export const fr = {
  "app": {
    ...
    "starting": "Démarrage de Pi-Desktop-Next…",
  ...
  "tray": {
    ...
    "pinned": "Épinglées",
    "viewMore": "Voir plus…",
    "open": "Ouvrir Pi-Desktop-Next",
    "quit": "Quitter Pi-Desktop-Next",
    "askTitle": "Garder Pi-Desktop-Next en arrière-plan ?",
    "askBody": "Lorsque vous fermez la fenêtre, Pi-Desktop-Next peut continuer à s'exécuter dans la barre d'état système afin que rien ne soit perdu. Vous pouvez modifier cela à tout moment dans les paramètres.",
    "closeToTray": "Près du bac",
    "confirmQuitTitle": "Quitter Pi-Desktop-Next ?",
  ...
  "chat": {
    ...
    "placeholder": "Demandez à Pi-Desktop-Next de vous aider pour tout",
...
sklm: {
    ...
    "pluginProviderKeyHint":
      "Stockée dans Pi-Desktop-Next et utilisée par l'environnement d'exécution. Le plugin ne la reçoit jamais.",
...
"importConfirm": "Les extensions importées s’exécutent dans le processus de l’agent avec les mêmes droits que ses outils. Les compétences déclarées peuvent ajouter des instructions à l’agent et les dépendances déclarées sont installées avec npm (scripts d’installation désactivés). Continuer ?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Ajoute les fournisseurs définis par ce plugin à la liste des fournisseurs des Paramètres. Le plugin fournit le point de terminaison et les modèles ; votre clé API reste dans Pi-Desktop-Next.",
      "desktop.control": "Permet d'appeler le catalogue Pi-Desktop-Next contrôlé ; les opérations destructrices exigent toujours confirm=true et le bearer token MCP n'est pas exposé.",
      ...
      "keyboard.globalShortcut": "Enregistre des raccourcis clavier système qui déclenchent les commandes propres à ce plugin lorsque Pi-Desktop-Next n'est pas au premier plan.",
  ...
  "status": {
    ...
    "dbSchemaTooNew":
      "Cette version de Pi-Desktop-Next est plus ancienne que vos données locales (schéma de données {{found}}, cette version prend en charge {{supported}}). Installez la version plus récente de Pi-Desktop-Next qui a ouvert ces données en dernier, ou une version ultérieure.",
    "archMismatch":
