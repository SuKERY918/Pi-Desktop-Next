export const en = {
  app: {
    ...
    starting: "Starting Pi-Desktop-Next…",
  ...
  tray: {
    ...
    pinned: "Pinned",
    viewMore: "View more…",
    open: "Open Pi-Desktop-Next",
    quit: "Quit Pi-Desktop-Next",
    askTitle: "Keep Pi-Desktop-Next running in the background?",
    askBody:
      "When you close the window, Pi-Desktop-Next can keep running in the system tray so nothing is lost. You can change this any time in Settings.",
    closeToTray: "Close to tray",
    confirmQuitTitle: "Quit Pi-Desktop-Next?",
    confirmQuitBody:
  ...
  chat: {
    ...
    placeholder: "Ask Pi-Desktop-Next to help with anything",
...
sklm: {
    ...
    pluginProviderKeyHint:
      "Stored in Pi-Desktop-Next and used by the runtime. The plugin never receives it.",
...
importConfirm: "Imported extensions run inside the agent process with the same access as the agent's own tools. Declared skills can add instructions to the agent, and declared dependencies are installed with npm (install scripts disabled). Continue?",
    ...
    permissionHelp: {
      ...
      "provider.register":
        "Adds the providers this plugin defines to Settings' provider list. The plugin supplies the endpoint and models; your API key stays in Pi-Desktop-Next.",
      "desktop.control":
        "Lets the plugin invoke the reviewed Pi-Desktop-Next control catalog. Destructive operations still require confirm=true; the MCP bearer token is never exposed.",
      ...
      "keyboard.globalShortcut": "Registers system-wide keyboard shortcuts that trigger this plugin's own commands while Pi-Desktop-Next is not focused.",
  ...
  status: {
    ...
    dbSchemaTooNew:
      "This Pi-Desktop-Next is older than your local data (data schema {{found}}, this build supports {{supported}}). Install the newer Pi-Desktop-Next that last opened this data, or a later version.",
    archMismatch:
