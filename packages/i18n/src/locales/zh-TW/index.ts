...
export const zhTW = {
  ...
  tray: {
    ...
    pinned: "釘選",
    viewMore: "查看更多…",
    open: "開啟 Pi-Desktop-Next",
    quit: "退出 Pi-Desktop-Next",
    askTitle: "關閉後繼續在後臺執行 Pi-Desktop-Next？",
    askBody:
      "關閉視窗後，Pi-Desktop-Next 可以繼續在系統托盤中執行，避免丟失任何內容。你隨時可以在設定中更改此選項。",
    closeToTray: "關閉到托盤",
    confirmQuitTitle: "確定退出 Pi-Desktop-Next？",
    confirmQuitBody:
  ...
  chat: {
    ...
    placeholder: "讓 Pi-Desktop-Next 幫你做任何事",
...
sklm: {
    ...
    pluginProviderKeyHint: "儲存在 Pi-Desktop-Next 中，由執行環境使用。外掛拿不到此金鑰。",
    ...
    thinkingDisplayModeDesc: "詳細模式依原文展開思考、工具與中間文字，不合成處理區塊。精簡模式將過程收進處理區塊，思考中僅顯示狀態提示，結束後隱藏思考區塊。",
  ...
  plugins: {
    ...
    permissionHelp: {
      ...
      "provider.register": "把此外掛定義的服務新增到設定的服務列表。介面地址和模型由外掛提供，API 金鑰則留在 Pi-Desktop-Next 中。",
      "desktop.control": "允許外掛呼叫經過審查的 Pi-Desktop-Next 操作目錄；破壞性操作仍需 confirm=true，外掛永遠拿不到 MCP bearer token。",
      ...
      "keyboard.globalShortcut": "註冊系統級快捷鍵，在 Pi-Desktop-Next 未聚焦時觸發此外掛自己的命令。",
  ...
  status: {
    ...
    dbSchemaTooNew:
      "目前的 Pi-Desktop-Next 比本機資料更舊（資料庫 schema {{found}}，此版本僅支援 {{supported}}）。請安裝上次開啟這些資料的較新版本，或更高版本。",
    archMismatch:
